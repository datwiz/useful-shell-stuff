# Generated by Powerlevel10k configuration wizard on 2022-06-16 at 09:21 AEST.
...
# 24h time, vertical separators, round heads, round tails, 2 lines, solid, left frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_SRC_FOREGROUND=31
  typeset -g POWERLEVEL9K_DIR_SRC_SHORTENED_FOREGROUND=103
  typeset -g POWERLEVEL9K_DIR_SRC_ANCHOR_FOREGROUND=39

  # Styling for WORK_NOT_WRITABLE.
  typeset -g POWERLEVEL9K_DIR_SRC_NOT_WRITABLE_VISUAL_IDENTIFIER_EXPANSION='⭐'
  typeset -g POWERLEVEL9K_DIR_SRC_NOT_WRITABLE_FOREGROUND=31
  typeset -g POWERLEVEL9K_DIR_SRC_NOT_WRITABLE_SHORTENED_FOREGROUND=103
  typeset -g POWERLEVEL9K_DIR_SRC_NOT_WRITABLE_ANCHOR_FOREGROUND=39

  # Styling for WORK_NON_EXISTENT.
  typeset -g POWERLEVEL9K_DIR_SRC_NON_EXISTENT_VISUAL_IDENTIFIER_EXPANSION='⭐'
  typeset -g POWERLEVEL9K_DIR_SRC_NON_EXISTENT_FOREGROUND=31
  typeset -g POWERLEVEL9K_DIR_SRC_NON_EXISTENT_SHORTENED_FOREGROUND=103
  typeset -g POWERLEVEL9K_DIR_SRC_NON_EXISTENT_ANCHOR_FOREGROUND=39
